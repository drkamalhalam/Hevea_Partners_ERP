...
export const salesTransactionsTable = pgTable("sales_transactions", {
  ...
  totalGrossRevenue: numeric("total_gross_revenue", { precision: 14, scale: 2 }).notNull().default("0"),
  totalDeductions: numeric("total_deductions", { precision: 14, scale: 2 }).notNull().default("0"),
  totalNetRevenue: numeric("total_net_revenue", { precision: 14, scale: 2 }).notNull().default("0"),
