...
export const projectsTable = pgTable("projects", {
   ...
   */
  landNotionalValue: numericFlex("land_notional_value", { precision: 15, scale: 2 }),
  landValuePerUnit: numericFlex("land_value_per_unit", { precision: 15, scale: 2 }),
  /**
  ...
  perTreeValue: numericFlex("per_tree_value", { precision: 15, scale: 2 }),
