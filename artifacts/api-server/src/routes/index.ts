...
import projectCardSummaryRouter from "./project_card_summary";
...
import documentVariablesRouter from "./document_variables";
...
import workAssignmentsRouter from "./work_assignments";
...
import projectParcelsRouter from "./project_parcels";
import projectAuditTrailRouter from "./project_audit_trail";
import projectAgreementTemplateRouter from "./project_agreement_template";
import adminGovernanceRouter from "./admin_governance";
import dataHealthRouter from "./data_health";
import enterpriseIntelligenceRouter from "./enterprise_intelligence";
import fieldOpsRouter from "./field_ops";
...
router.use("/projects", projectCardSummaryRouter);
...
router.use("/document-variables", documentVariablesRouter);
...
router.use("/projects", projectParcelsRouter);
router.use("/projects", projectAuditTrailRouter);
router.use("/projects", projectAgreementTemplateRouter);
router.use("/admin/governance", adminGovernanceRouter);
router.use("/admin/data-health", dataHealthRouter);
router.use("/enterprise-intelligence", enterpriseIntelligenceRouter);
