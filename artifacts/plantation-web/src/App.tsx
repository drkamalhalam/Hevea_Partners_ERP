...
import ReportAccessAudit from "./pages/ReportAccessAudit";
        ...
        <RoleProvider>
          <TooltipProvider>
            <Switch>
              ...
              <Route path="/governance-audit-reports"><ProtectedRoute component={GovernanceAuditReports} /></Route>
              <Route path="/data-health"><AdminRoute component={DataHealth} /></Route>
              ...
              <Route path="/report-access-audit"><AdminRoute component={ReportAccessAudit} /></Route>
